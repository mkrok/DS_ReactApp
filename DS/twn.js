...
global._Tween = function( target, duration, type, repeat, yoyo, callback )
{
    if( target==null ) { 
        if( this.tween ) { this.tweenCancel=true; this.tween=null; app._117(true) }
        return;
    }
    app._117( false );
    var _this = this;
...
//If not NodeJS
if( false && typeof module=='undefined' )
{
