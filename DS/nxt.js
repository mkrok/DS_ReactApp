...
function _NxtHelp()
{
	...
	this.nxt_OnSelect = function( name, address )
	{
		...
		if( this.nxt.IsConnected() ) { this.nxt.Disconnect(); app._107(1); }
	...
	this.nxt_OnConnect = function( success )
	{
		...
		else app._108( "Failed to connect!" );
		app._137();
	...
	this.nxt_Connect = function()
	{
		if( !this.nxt.IsPaired( this.nxtName ) ) { 
			app._108( this.nxtName + " is not Paired!" ); 
			return; 
		}
		//Connect to NXT.
		app._136( "Connecting..." );
