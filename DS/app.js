...
function DsApp()
{
	this.data = {};
	this.typeId = "DsApp"
	/*#app*/ this._0 = function() { return "DsApp"; }
	/*#app*/ this._1 = function() { return _GetObjects(); }
	/*#app*/ this._2 = function() { return prompt( "#", "App.IsStarted(" )=="true"; }
	/*#app*/ this._3 = function( kill ) { prompt( "#", "App.Exit("+kill ); }
	/*#app*/ this._4 = function( msg,title,options ) { prompt( "#", "App.Quit(\f"+msg+"\f"+title+"\f"+options ); }
	/*#app*/ this._5 = function() { prompt( "#", "App.ToBack(" ); }
	/*#app*/ this._6 = function() { prompt( "#", "App.ToFront(" ); }
	/*#app*/ this._7 = function() { prompt( "#", "App.Hide(" ); }
	/*#app*/ this._8 = function() { prompt( "#", "App.Show(" ); }
	/*#app*/ this._9 = function( ms ) { prompt( "#", "_DoEvents(\f"+ms ); }
	/*#app*/ this.Execute = function( js ) { prompt( "#", "App.Execute("+js ); }
	/*#app*/ this._11 = function( file,options,intent ) { prompt( "#", "App.StartApp(\f"+file+"\f"+options+"\f"+intent ); }
	/*#app*/ this._12 = function( name ) { prompt( "#", "App.StopApp("+name ); }
	/*#app*/ this._13 = function( packageName,noPlay ) { prompt( "#", "App.LaunchApp(\f"+packageName+"\f"+noPlay ); }
	/*#app*/ this._14 = function( mode ) { prompt( "#", "App.SetScreenMode(\f"+mode ); }
	/*#app*/ this._15 = function( options ) { prompt( "#", "App.SetOptions(\f"+options ); }
	/*#app*/ this._16 = function( theme ) { prompt( "#", "App.SetTheme(\f"+(theme?theme.id:null) ); }
	/*#app*/ this._17 = function() { return eval(prompt( "#", "App.GetThemeInfo(" )); }
	/*#app*/ this._18 = function( dpi ) { prompt( "#", "App.SetDensity(\f"+dpi ); }
	/*#app*/ this._19 = function( left,top,width,height,options ) { prompt( "#", "App.SetPosition(\f"+left+"\f"+top+"\f"+width+"\f"+height+"\f"+options ); }
	/*#app*/ this._20 = function( clr ) { prompt( "#", "App.SetBackColor(\f"+clr ); }
	/*#app*/ this._21 = function( clr ) { prompt( "#", "App.SetNavBarColor(\f"+clr ); }
	/*#app*/ this._22 = function( clr ) { prompt( "#", "App.SetStatusBarColor(\f"+clr ); }
	/*#app*/ this._23 = function( packageName,className ) { prompt( "#", "App.StartService(\f"+packageName+"\f"+className ); }
	/*#app*/ this._24 = function() { prompt( "#", "App.StopService(" ); }
	/*#app*/ this._25 = function( delay,options ) { prompt( "#", "App.ScheduleJob(\f"+delay+"\f"+options ); }
	/*#app*/ this._26 = function() { prompt( "#", "App.CancelJob(" ); }
	/*#app*/ this._27 = function( options ) { prompt( "#", "App.StartDebugServer(\f"+options ); }
	/*#app*/ this._28 = function() { prompt( "#", "App.StopDebugServer(" ); }
	/*#app*/ this._29 = function( packageName,className,action,category,uri,type,extras,options,callback ) { prompt( "#", "App.SendIntent(\f"+packageName+"\f"+className+"\f"+action+"\f"+category+"\f"+uri+"\f"+type+"\f"+extras+"\f"+options+"\f"+_Cbm(callback) ); }
	/*#app*/ this._30 = function( action,category,data,type,extras,options ) { prompt( "#", "App.BroadcastIntent(\f"+action+"\f"+category+"\f"+data+"\f"+type+"\f"+extras+"\f"+options ); }
	/*#app*/ this._31 = function( msg ) { prompt( "#", "App.SendMessage(\f"+msg ); }
	/*#app*/ this._32 = function( title,text,largeIcon,smallIcon,importance ) { prompt( "#", "App.SetInForeground(\f"+title+"\f"+text+"\f"+largeIcon+"\f"+smallIcon+"\f"+importance ); }
	/*#app*/ this._33 = function() { prompt( "#", "App.SetInBackground(\f" ); }
	/*#app*/ this._34 = function( file, noDefer ) { _LoadScriptSync( file, noDefer?false:true ); }
	/*#app*/ this._35 = function( url, callback ) { _LoadScript( url, callback ); }
	/*#app*/ this._36 = function( url ) { _LoadPlugin( url ); }
	/*#app*/ this._37 = function( cmd,options,maxRead,timeout ) { return prompt( "#", "App.SysExec(\f"+cmd+"\f"+options+"\f"+maxRead+"\f"+timeout ); }
	/*#app*/ this._38 = function( name,file,args,options ) { return prompt( "#", "App.ExtExec(\f"+name+"\f"+file+"\f"+args+"\f"+options ); }
	/*#app*/ this._39 = function( level ) { prompt( "#", "App.SetPriority(\f"+level ); }
	/*#app*/ //this.Odroid = function( p1,p2,p3 ) { return prompt( "#", "App.Odroid(\f"+p1+"\f"+p2+"\f"+p3 ); }
	/*#app*/ this._40 = function() { return prompt( "#", "App.GetName(" ); }
	/*#app*/ this._41 = function() { return prompt( "#", "App.GetPath(" ); }
	/*#app*/ this._42 = function() { return prompt( "#", "App.GetAppName(" ); }
	/*#app*/ this._43 = function() { return prompt( "#", "App.GetAppPath(" ); }
	/*#app*/ this._44 = function() { return parseFloat(prompt( "#", "App.GetVersion(" )); }
	/*#app*/ this._45 = function() { return parseFloat(prompt( "#", "App.GetDSVersion(" )); }
	/*#app*/ this._46 = function() { return parseInt(prompt( "#", "App.GetDSBuild(" )); }
	/*#app*/ this._47 = function() { return prompt( "#", "App.IsNewVersion(" )=="true"; }
	/*#app*/ this._48 = function() { return prompt( "#", "App.InIDE(" )=="true"; }
	/*#app*/ this._49 = function() { return prompt( "#", "App.IsAPK(" )=="true"; }
	/*#app*/ this._50 = function() { return prompt( "#", "App.IsService(" )=="true"; }
	/*#app*/ this._51 = function() { return prompt( "#", "App.IsPremium(" )=="true"; }
	/*#app*/ this._52 = function() { return prompt( "#", "App.IsEngine(" )=="true"; }
	/*#app*/ this._53 = function() { return prompt( "#", "App.IsScoped(" )=="true"; }
	/*#app*/ this._54 = function() { return prompt( "#", "App.GetPackageName(" ); }
	/*#app*/ this._55 = function( key ) { prompt( "#", "App.CheckLicense(\f"+key ); }
	/*#app*/ this._56 = function() { return prompt( "#", "App.GetAccounts(" ); }
	/*#app*/ this._57 = function() { return prompt( "#", "App.GetUser(" ); }
	/*#app*/ this._58 = function() { return prompt( "#", "App.GetDeviceId(" ); }
	/*#app*/ this._59 = function() { return prompt( "#", "App.GetCountryCode(" ); }
	/*#app*/ this._60 = function() { return prompt( "#", "App.GetLanguageCode(" ); }
	/*#app*/ this._61 = function() { return prompt( "#", "App.GetCountry(" ); }
	/*#app*/ this._62 = function() { return prompt( "#", "App.GetLanguage(" ); }
	/*#app*/ this._63 = function() { return prompt( "#", "App.GetOptions(" ); }
	/*#app*/ this._64 = function( index ) { return prompt( "#", "App.GetSharedText("+index ); }
	/*#app*/ this._65 = function() { var s = prompt( "#", "App.GetSharedFiles(" ); if(s.length) return s.split(","); else return null; }
	/*#app*/ this._66 = function() { return eval(prompt( "#", "App.GetActivities(" )); }
	/*#app*/ this._67 = function( packageName ) { return prompt( "#", "App.IsAppInstalled(\f"+packageName )=="true"; }
	/*#app*/ this._68 = function() { return eval(prompt( "#", "App.GetInstalledApps(\f" )); }
	/*#app*/ this._69 = function() { return eval(prompt( "#", "App.GetRunningApps(\f" )); }
	/*#app*/ this._70 = function() { return eval(prompt( "#", "App.GetRunningServices(\f" )); }
	/*#app*/ this._71 = function() { return eval(prompt( "#", "App.GetMemoryInfo(\f" )); }
	/*#app*/ this._72 = function() { var s = prompt( "#", "App.GetIntent(" ); if(s.length) return JSON.parse(s); else return null; }
	/*#app*/ this._73 = function() { return prompt( "#", "App.GetNotifyId(" ); }
	/*#app*/ this._74 = function( name ) { prompt( "#", "App.SetSharedApp("+name ); }
	/*#app*/ this._75 = function( appName,ext ) { return prompt( "#", "App.GetMediaFile(\f"+appName+"\f"+ext ); }
	/*#app*/ this._76 = function() { return prompt( "#", "App.HasExternalStorage(" )=="true"; }
	/*#app*/ this._77 = function( procId ) { prompt( "#", "App.KillApp("+procId ); }
	/*#app*/ this._78 = function( name,iconFile,file,options ) { prompt( "#", "App.CreateShortcut(\f"+name+"\f"+iconFile+"\f"+file+"\f"+options ); }
	/*#app*/ this._79 = function() { var s = prompt( "#", "App.GetShortcuts(" ); if(s.length) return JSON.parse(s); else return null; }
	/*#app*/ this._80 = function() { return parseInt( prompt( "#", "App.GetBuildNum(" )); }
	/*#app*/ this._81 = function() { return parseInt( prompt( "#", "App.GetBuildNum(" )); }
	/*#app*/ this._82 = function() { return prompt( "#", "App.GetModel(" ); }
	/*#app*/ this._83 = function() { return prompt( "#", "App.IsTablet(" )=="true"; }
	/*#app*/ this._84 = function() { return prompt( "#", "App.IsChrome(" )=="true"; }
	/*#app*/ this._85 = function() { return prompt( "#", "App.IsTV(" )=="true"; }
	/*#app*/ this._86 = function( filter ) { prompt( "#", "App.SetErrorFilter(\f"+filter ); }
	/*#app*/ this._87 = function( callback ) { prompt( "#", "App.SetOnError(\f"+_Cbm(callback) ); }
	/*#app*/ this._88 = function( callback ) { prompt( "#", "App.SetOnDebug(\f"+_Cbm(callback) ); }
	/*#app*/ this._89 = function( callback ) { prompt( "#", "App.SetOnKey(\f"+_Cbm(callback) ); }
	/*#app*/ this._90 = function( callback ) { prompt( "#", "App.SetOnShowKeyboard(\f"+_Cbm(callback) ); }
	/*#app*/ this._91 = function( callback ) { prompt( "#", "App.SetOnWifiChange(\f"+_Cbm(callback) ); }
	/*#app*/ this._92 = function( callback,options ) { prompt( "#", "App.WifiScan(\f"+_Cbm(callback)+"\f"+options ); }
	/*#app*/ this._93 = function( keyList ) { prompt( "#", "App.DisableKeys(\f"+keyList ); }
	/*#app*/ this._94 = function( disable ) { prompt( "#", "App.DisableTouch(\f"+disable ); }
	/*#app*/ this._95 = function() { return prompt( "#", "App.GetIPAddress(" ); }
	/*#app*/ this._96 = function() { return prompt( "#", "App.GetMacAddress(" ); }
	/*#app*/ this._97 = function() { return prompt( "#", "App.GetRouterAddress(" ); }
	/*#app*/ this._98 = function() { return prompt( "#", "App.GetSSID(" ); }
	/*#app*/ this._99 = function() { return parseInt(prompt( "#", "App.GetRSSI(" )); }
	/*#app*/ this._100 = function( type,msg,options ) { prompt( "#", "App.Broadcast(\f"+type+"\f"+msg+"\f"+options ); }
	/*#app*/ this._101 = function( callback,action ) { prompt( "#", "App.SetOnBroadcast(\f"+_Cbm(callback)+"\f"+action ); }
	/*#app*/ this._102 = function( name,value ) { prompt( "#", "App.SetData(\f"+name+"\f"+value ); }
	/*#app*/ this._103 = function( name ) { return prompt( "#", "App.GetData(\f"+name ); }
	/*#app*/ this._104 = function( txt ) { prompt( "#", "App.SetClipboardText("+txt ); }
	/*#app*/ this._105 = function() { return prompt( "#", "App.GetClipboardText(" ); }
	/*#app*/ this._106 = function( enable ) { prompt( "#", "App.EnableBackKey("+enable ); }
	/*#app*/ this._107 = function( secs,doEvents ) { prompt( "#", "App.Wait(\f"+secs+"\f"+doEvents ); }
	/*#app*/ this._108 = function( msg,title,options,hue ) { if(title) prompt( "#", "App.Alert(\f"+msg+"\f"+title+"\f"+options+"\f"+hue ); else alert(msg); }
	/*#app*/ this._109 = function() { prompt( "#", "App.HideDialogs(" ); }
	/*#app*/ this._110 = function() { prompt( "#", "App.HideKeyboard(" ); }
	/*#app*/ this._111 = function( obj ) { return prompt( "#", "App.ShowKeyboard(\f"+obj.id )=="true"; }
	/*#app*/ this._112 = function() { return prompt( "#", "App.IsKeyboardShown(" )=="true"; }
	/*#app*/ this._113 = function() { return parseInt(prompt( "#", "App.GetKeyboardHeight(" )); }
	/*#app*/ this._114 = function( text,pitch,rate,callback,stream,locale,engine ) { prompt( "#", "App.TextToSpeech(\f"+text+"\f"+pitch+"\f"+rate+"\f"+_Cbm(callback)+"\f"+stream+"\f"+locale+"\f"+engine ); }
	/*#app*/ this._115 = function( msg ) { prompt( "#", "App.Debug(\f"+(typeof msg=='object'?JSON.stringify(msg):msg) ); }
	/*#app*/ this._116 = function( msg,line,file,quit ) { prompt( "#", "App.Error(\f"+msg+"\f"+line+"\f"+file+"\f"+quit ); }
	/*#app*/ this._117 = function( enable ) { prompt( "#", "_UseDbg(\f"+enable ); _dbg=enable; }
	/*#app*/ this._118 = function( switches ) { prompt( "#", "_UseDbg(\f"+switches ); _dbg=switches; }
	/*#app*/ this._119 = function() { return prompt( "#", "_GetDbg(\f" ); }
	/*#app*/ this._120 = function() { return _dbg?true:false; }
	/*#app*/ this._121 = function() { return prompt( "#", "App.IsDebugging(" )=="true"; }
	/*#app*/ this._122 = function() { return prompt( "#", "App.IsDebugVisible(" )=="true"; }
	/*#app*/ this._123 = function( options ) { prompt( "#", "App.CreateDebug(\f"+options ); }
	/*#app*/ this._124 = function( show,options ) { prompt( "#", "App.ShowDebug(\f"+show+"\f"+options ); }
	/*#app*/ this._125 = function( address,subject,body,attach,type,options ) { prompt( "#", "App.SendMail(\f"+address+"\f"+subject+"\f"+body+"\f"+attach+"\f"+type+"\f"+options ); }
	/*#app*/ this._126 = function( file,subject,text,choose ) { prompt( "#", "App.SendFile(\f"+file+"\f"+subject+"\f"+text+"\f"+choose ); }
	/*#app*/ this._127 = function( text,subject,choose ) { prompt( "#", "App.SendText(\f"+text+"\f"+subject+"\f"+choose ); }
	/*#app*/ this._128 = function( file,choose ) { prompt( "#", "App.SendImage(\f"+file+"\f"+choose ); }
	/*#app*/ this._129 = function( msg,number ){ app._29(null,null,"android.intent.action.SENDTO",null,'smsto:'+number,null,JSON.stringify([{name:"sms_body",type:"string",value:msg}])); }
	// this._Extract = function( p1 ) { prompt( "#", "App._Extract("+p1 ); }
	/*#app*/ this._130 = function( src,dest,overwrite,options,filter ) { prompt( "#", "App.ExtractAssets(\f"+src+"\f"+dest+"\f"+overwrite+"\f"+options+"\f"+filter ); }
	/*#app*/ this._131 = function( dir ) { prompt( "#", "App.RedirectAssets(\f"+dir ); }
	/*#app*/ this._132 = function() { prompt( "#", "App.ExtractPlugins(\f" ); }
	/*#app*/ this._133 = function( name,options ) { return parseInt(prompt( "#", "App.GetResourceId(\f"+name+"\f"+options )); }
	/*#app*/ this._134 = function( pattern ) { prompt( "#", "App.Vibrate("+pattern ); }
	/*#app*/ this._135 = function( msg,options ) { prompt( "#", "App.ShowPopup("+msg+"\f"+options ); }
	/*#app*/ this._136 = function( msg,options ) { prompt( "#", "App.ShowProgress(\f"+msg+"\f"+options ); }
	/*#app*/ this._137 = function() { prompt( "#", "App.HideProgress(" ); }
	/*#app*/ this._138 = function( title,percent,options ) { prompt( "#", "App.ShowProgressBar(\f"+title+"\f"+percent+"\f"+options ); }
	/*#app*/ this._139 = function( percent,options ) { prompt( "#", "App.UpdateProgressBar(\f"+percent+"\f"+options ); }
	/*#app*/ this._140 = function() { prompt( "#", "App.HideProgressBar(" ); }
	/*#app*/ this._141 = function( name,dflt,file ) { return prompt( "#", "App.LoadText("+name+"\f"+dflt+"\f"+file ); }
	/*#app*/ this._142 = function( name,dflt,file ) { return parseFloat(prompt( "#", "App.LoadNumber("+name+"\f"+dflt+"\f"+file )); }
	/*#app*/ this._143 = function( name,dflt,file ) { return (prompt( "#", "App.LoadBoolean("+name+"\f"+dflt+"\f"+file )=="true"); }
	/*#app*/ this._144 = function(name,dflt,file) { try { return JSON.parse(prompt("#","App.LoadText("+name+"\f"+dflt+"\f"+file)); } catch(e) { app._115("WARNING: app._144 Failed: "+e); } }
	/*#app*/ this._145 = function( name,value,file ) { prompt( "#", "App.SaveText("+name+"\f"+value+"\f"+file ); }
	/*#app*/ this._146 = function( name,value,file ) { prompt( "#", "App.SaveNumber("+name+"\f"+value+"\f"+file ); }
	/*#app*/ this._147 = function( name,value,file ) { prompt( "#", "App.SaveBoolean("+name+"\f"+value+"\f"+file ); }
	/*#app*/ this._148 = function(name,data,file) { try { prompt("#","App.SaveText("+name+"\f"+JSON.stringify(data)+"\f"+file); } catch(e) { app._115("WARNING: app._148 Failed: "+e); } }
	/*#app*/ this._149 = function( file ) { prompt( "#", "App.ClearData(\f"+file ); }
	/*#app*/ this._150 = function( name,file ) { prompt( "#", "App.ClearValue(\f"+name+"\f"+file ); }
	/*#app*/ this._151 = function() { return parseFloat(prompt( "#", "App.GetTop(" )); }
	/*#app*/ this._152 = function() { return prompt( "#", "App.HasSoftNav(" )=="true"; }
	/*#app*/ this._153 = function() { return prompt( "#", "App.IsNavBarOnRight(" )=="true"; }
	/*#app*/ this._154 = function( options ) { return parseFloat(prompt( "#", "App.GetScreenWidth(\f"+options )); }
	/*#app*/ this._155 = function( options ) { return parseFloat(prompt( "#", "App.GetScreenHeight(\f"+options )); }
	/*#app*/ this._156 = function() { return parseFloat(prompt( "#", "App.GetScreenDensity(" )); }
	/*#app*/ this._157 = function() { return parseFloat(prompt( "#", "App.GetDisplayWidth(" )); }
	/*#app*/ this._158 = function() { return parseFloat(prompt( "#", "App.GetDisplayHeight(" )); }
	/*#app*/ this._159 = function() { return prompt( "#", "App.GetDefaultOrientation(" ); }
	/*#app*/ this._160 = function() { return prompt( "#", "App.GetOrientation(" ); }
	/*#app*/ this._161 = function() { return prompt( "#", "App.GetOrientation(" )=="Portrait"; }
	/*#app*/ this._162 = function( orient,callback ) { prompt( "#", "App.SetOrientation(\f"+orient+"\f"+_Cbm(callback) ); }
	/*#app*/ this._163 = function() { return parseInt(prompt( "#", "App.GetRotation(" )); }
	/*#app*/ this._164 = function() { return parseFloat(prompt( "#", "App.GetBatteryLevel(\f" )); }
	/*#app*/ this._165 = function() { return prompt( "#", "App.IsBatteryOptimized(" )=="true"; }
	/*#app*/ this._166 = function() { return prompt( "#", "App.IsCharging(" )=="true"; }
	/*#app*/ this._167 = function() { prompt( "#", "App.ShowBatterySettings(" ); }
	/*#app*/ this._168 = function() { return prompt( "#", "App.GetChargeType(\f" ); }
	/*#app*/ this._169 = function( mode ) { prompt( "#", "App.PreventScreenLock("+mode ); }
	/*#app*/ this._170 = function() { prompt( "#", "App.PreventWifiSleep(" ); }
	/*#app*/ this._171 = function( enable ) { prompt( "#", "App.SetWifiEnabled(\f"+enable ); }
	/*#app*/ this._172 = function() { return prompt( "#", "App.IsWifiEnabled(" )=="true"; }
	/*#app*/ this._173 = function( enable,ssid,key ) { prompt( "#", "App.SetWifiApEnabled(\f"+enable+"\f"+ssid+"\f"+key ); }
	/*#app*/ this._174 = function() { return prompt( "#", "App.IsWifiApEnabled(" )=="true"; }
	/*#app*/ this._175 = function( ssid,key ) { prompt( "#", "App.WifiConnect(\f"+ssid+"\f"+key ); }
	/*#app*/ this._176 = function() { return prompt( "#", "App.IsConnected(" )=="true"; }
	/*#app*/ this._177 = function( enable ) { prompt( "#", "App.SetBluetoothEnabled(\f"+enable ); }
	/*#app*/ this._178 = function() { return prompt( "#", "App.IsBluetoothEnabled(" )=="true"; }
	/*#app*/ this._179 = function() { return eval(prompt( "#", "App.GetPairedBTDevices(\f" )); }
	/*#app*/ this._180 = function( name ) { return prompt( "#", "App.IsBtDevicePaired(\f"+name )=="true"; }
	/*#app*/ this._181 = function( filter,onFound,onComplete ) { prompt( "#", "App.DiscoverBtDevices(\f"+filter+"\f"+_Cbm(onFound)+"\f"+_Cbm(onComplete) ); }
	/*#app*/ this._182 = function( address,callback ) { prompt( "#", "App.PairBtDevice(\f"+address+"\f"+_Cbm(callback) ); }
	/*#app*/ this._183 = function( address,callback ) { prompt( "#", "App.UnpairBtDevice(\f"+address+"\f"+_Cbm(callback) ); }
	/*#app*/ this._184 = function( type ) { return prompt( "#", "App.GetBtProfileState(\f"+type ); }
	/*#app*/ this._185 = function() { return prompt( "#", "App.GetBluetoothName(" ); }
	/*#app*/ this._186 = function() { return prompt( "#", "App.GetBluetoothAddress(" ); }
	/*#app*/ this._187 = function( types ) { return prompt( "#", "App.IsLocationEnabled(\f"+types )=="true"; }
	/*#app*/ this._188 = function( lat,lng,accuracy,speed ) { prompt( "#", "App.SetMockLocation(\f"+lat+"\f"+lng+"\f"+accuracy+"\f"+speed ); }
	/*#app*/ this._189 = function( type ) { prompt( "#", "App.PlayRingtone(\f"+type ); }
	/*#app*/ this._190 = function( mode ) { prompt( "#", "App.SetRingerMode(\f"+mode ); }
	/*#app*/ this._191 = function() { return prompt( "#", "App.GetRingerMode(" ); }
	/*#app*/ this._192 = function( on ) { prompt( "#", "App.SetSpeakerPhone(\f"+on ); }
	/*#app*/ this._193 = function() { return prompt( "#", "App.GetSpeakerPhone(" )=="true"; }
	/*#app*/ this._194 = function( stream,level,options ) { prompt( "#", "App.SetVolume(\f"+stream+"\f"+level+"\f"+options ); }
	/*#app*/ this._195 = function( stream ) { return parseFloat(prompt( "#", "App.GetVolume(\f"+stream )); }
	/*#app*/ this._196 = function( title ) { prompt( "#", "App.SetTitle("+title ); }
	/*#app*/ this._197 = function( list,iconPath ) { prompt( "#", "App.SetMenu("+list+"\f"+iconPath ); }
	/*#app*/ this._198 = function() { prompt( "#", "App.ShowMenu(" ); }
	/*#app*/ this._199 = function( cancel,ok ) { prompt( "#", "App.Translate(\f"+cancel+"\f"+ok ); }
	/*#app*/ this._200 = function( layout,type,options ) { if( !type ) prompt( "#", "App.AddLayout("+layout.id ); else { var ret = prompt( (layout?layout.id:null), "App.AddLayout("+type+"\f"+options ); if( ret ) return new Lay(ret); else return null; } }
	/*#app*/ this._201 = function( layout ) { prompt( "#", "App.RemoveLayout("+ layout.id ); }
	/*#app*/ this._202 = function( layout ) { prompt( "#", "App.DestroyLayout("+ layout.id ); }
	/*#app*/ this._203 = function( layout,side,width,grabWidth ) { prompt( "#", "App.AddDrawer(\f"+layout.id+"\f"+side+"\f"+width+"\f"+grabWidth ); }
	/*#app*/ this._204 = function( side ) { prompt( "#", "App.RemoveDrawer(\f"+ side ); }
	/*#app*/ this._205 = function( side ) { prompt( "#", "App.OpenDrawer(\f"+side ); }
	/*#app*/ this._206 = function( side ) { prompt( "#", "App.CloseDrawer(\f"+side ); }
	/*#app*/ this._207 = function( side ) { prompt( "#", "App.LockDrawer(\f"+side ); }
	/*#app*/ this._208 = function( side ) { prompt( "#", "App.UnlockDrawer(\f"+side ); }
	/*#app*/ this._209 = function( side ) { return prompt( "#", "App.GetDrawerState(\f"+side ); }
	/*#app*/ this._210 = function( fldr ) { prompt( "#", "App.MakeFolder("+fldr ); }
	/*#app*/ this._211 = function( name,options ) { return prompt( "#", "App.GetPrivateFolder(\f"+name+"\f"+options ); }
	/*#app*/ this._212 = function() { return prompt( "#", "App.GetPublicFolder(" ); }
	/*#app*/ this._213 = function() { return prompt( "#", "App.GetTempFolder(" ); }
	/*#app*/ this._214 = function() { return prompt( "#", "App.GetDatabaseFolder(" ); }
	/*#app*/ this._215 = function( name ) { prompt( "#", "App.DeleteDatabase(\f"+name); }
	/*#app*/ this._216 = function( fldr ) { return prompt( "#", "App.FolderExists("+fldr )=="true"; }
	/*#app*/ this._217 = function( file ) { return prompt( "#", "App.FileExists("+file )=="true"; }
	/*#app*/ this._218 = function( fldr ) { return prompt( "#", "App.IsFolder("+fldr )=="true"; }
	/*#app*/ this._219 = function( path,filter,limit,options ) { return eval(prompt( "#", "App.ListFolder(\f"+path+"\f"+filter+"\f"+limit+"\f"+options )); }
	/*#app*/ this._220 = function( path,filter,depth,limit,options ) { return JSON.parse(prompt( "#", "App.WalkFolder(\f"+path+"\f"+filter+"\f"+depth+"\f"+limit+"\f"+options )); }
	/*#app*/ this._221 = function() { return prompt( "#", "App.GetExternalFolder(" ); }
	/*#app*/ this._222 = function() { return prompt( "#", "App.GetInternalFolder(" ); }
	/*#app*/ this._223 = function( name ) { return prompt( "#", "App.GetSpecialFolder(\f"+name ); }
	/*#app*/ this._224 = function( name ) { return prompt( "#", "App.GetEnv(\f"+name ); }
	/*#app*/ this._225 = function( name,callback ) { prompt( "#", "App.GetPermission(\f"+name+"\f"+_Cbm(callback) ); }
	/*#app*/ this._226 = function( name ) { return prompt( "#", "App.CheckPermission(\f"+name ); }
	/*#app*/ this._227 = function( uri ) { return prompt( "#", "App.RemovePermission(\f"+uri ); }
	/*#app*/ this._228 = function( type ) { return prompt( "#", "App.ListPermissions(\f"+type ); }
	/*#app*/ this._229 = function( file,encoding ) { return prompt( "#", "App.ReadFile(\f"+file+"\f"+encoding ); }
	/*#app*/ this._230 = function( file,mode ) { return JSON.parse(prompt( "#", "App.ReadFileData(\f"+file+"\f"+mode )); }
	/*#app*/ this._231 = function( file,text,mode,encoding ) { prompt( "#", "App.WriteFile(\f"+file+"\f"+text+"\f"+mode+"\f"+encoding ); }
	/*#app*/ this._232 = function( file,type,choose ) { prompt( "#", "App.OpenFile(\f"+file+"\f"+type+"\f"+choose ); }
	/*#app*/ this._233 = function( url,type,choose ) { prompt( "#", "App.OpenUrl(\f"+url+"\f"+type+"\f"+choose ); }
	/*#app*/ this._234 = function( src,dest,title,desc,options ) { prompt( "#", "App.DownloadFile(\f"+src+"\f"+dest+"\f"+title+"\f"+desc+"\f"+options ); }
	/*#app*/ this._235 = function( msg,type,callback,fldr,options ) { prompt( "#", "App.ChooseFile(\f"+msg+"\f"+type+"\f"+_Cbm(callback)+"\f"+fldr+"\f"+options ); }
	/*#app*/ this._236 = function( type,callback ) { prompt( "#", "App.ChooseContact(\f"+type+"\f"+_Cbm(callback) ); }
	/*#app*/ this._237 = function( options,callback ) { prompt( "#", "App.ChooseImage(\f"+options+"\f"+_Cbm(callback) ); }
	/*#app*/ this._238 = function( callback ) { prompt( "#", "App.ChooseAccount(\f"+_Cbm(callback) ); }
	/*#app*/ this._239 = function( file ) { prompt( "#", "App.DeleteFile("+file); }
	/*#app*/ this._240 = function( src,dest ) { prompt( "#", "App.CopyFile("+src+"\f"+dest); }
	/*#app*/ this._241 = function( src,dest,overwrite,filter ) { prompt( "#", "App.CopyFolder(\f"+src+"\f"+dest+"\f"+overwrite+"\f"+filter); }
	/*#app*/ this._242 = function( fldr ) { prompt( "#", "App.DeleteFolder("+fldr); }
	/*#app*/ this._243 = function( src,dest ) { prompt( "#", "App.RenameFile(\f"+src+"\f"+dest); }
	/*#app*/ this._244 = function( src,dest ) { prompt( "#", "App.RenameFile(\f"+src+"\f"+dest); }
	/*#app*/ this._245 = function( file,txt,rep,options ) { prompt( "#", "App.ReplaceInFile(\f"+file+"\f"+txt+"\f"+rep+"\f"+options); }
	/*#app*/ this._246 = function( src,dest,options ) { prompt( "#", "App.UnzipFile(\f"+src+"\f"+dest+"\f"+options); }
	/*#app*/ this._247 = function( src,dest,options ) { prompt( "#", "App.ZipFile(\f"+src+"\f"+dest+"\f"+options); }
	/*#app*/ this._248 = function( src,dest,options ) { prompt( "#", "App.ZipFile(\f"+src+"\f"+dest+"\f"+options); }
	/*#app*/ this._249 = function( mode ) { return parseFloat(prompt( "#", "App.GetFreeSpace(\f"+mode)); }
	/*#app*/ this._250 = function( file ) { var d = parseInt(prompt( "#", "App.GetFileDate(\f"+file)); if( d ) return new Date(d); else return null; }
	/*#app*/ this._251 = function( file ) { return parseInt(prompt( "#", "App.GetFileSize(\f"+file)); }
	/*#app*/ this._252 = function( src,dest,width,height ) { prompt( "#", "App.GetThumbnail(\f"+src+"\f"+dest+"\f"+width+"\f"+height); }
	/*#app*/ this._253 = function( file ) { prompt( "#", "App.ScanFile(\f"+file); }
	/*#app*/ this._254 = function() { var ret = prompt( "#", "App.GetLastButton(" ); if( ret ) return (_map[ret]); else return null; }
	/*#app*/ this._255 = function() { var ret = prompt( "#", "App.GetLastToggle(" ); if( ret ) return (_map[ret]); else return null; }
	/*#app*/ this._256 = function() { var ret = prompt( "#", "App.GetLastCheckBox(" ); if( ret ) return (_map[ret]); else return null; }
	/*#app*/ this._257 = function() { var ret = prompt( "#", "App.GetLastImage(" ); if( ret ) return (_map[ret]); else return null; }
	/*#app*/ this._258 = function() { return prompt( "#", "App.IsBluetoothOn(" )=="true"; }
	/*#app*/ this._259 = function() { return prompt( "#", "App.IsScreenOn(" )=="true"; }
	/*#app*/ this._260 = function() { prompt( "#", "App.WakeUp(" ); }
	/*#app*/ this._261 = function() { prompt( "#", "App.GoToSleep(" ); }
	/*#app*/ this._262 = function() { prompt( "#", "App.Unlock(" ); }
	/*#app*/ this._263 = function() { prompt( "#", "App.Lock(" ); }
	/*#app*/ this._264 = function( level ) { prompt( "#", "App.SetScreenBrightness(\f"+level); }
	/*#app*/ this._265 = function( mode,enable,options,packages ) { prompt( "#", "App.SetKioskMode(\f"+mode+"\f"+enable+"\f"+options+"\f"+packages); }
	/*#app*/ this._266 = function( enable ) { prompt( "#", "App.PinScreen(\f"+enable); }
	/*#app*/ this._267 = function( file,keys ) { return prompt( "#", "App.GetMetadata(\f"+file+"\f"+keys); }
	/*#app*/ this._268 = function( type,id,callback,time,interval,options ) { return prompt( "#", "App.SetAlarm(\f"+type+"\f"+id+"\f"+_Cbm(callback)+"\f"+time+"\f"+interval+"\f"+options); }
	/*#app*/ this._269 = function( number ) { prompt( "#", "App.Call(\f"+number ); }
	/*#app*/ this._270 = function( obj,x,y,dir ) { prompt( "#", "App.SimulateTouch(\f"+obj.id+"\f"+x+"\f"+y+"\f"+dir ); }
	/*#app*/ this._271 = function( obj,x1,y1,x2,y2,step,pause ) { prompt( "#", "App.SimulateDrag(\f"+obj.id+"\f"+x1+"\f"+y1+"\f"+x2+"\f"+y2+"\f"+step+"\f"+pause ); }
	/*#app*/ this._272 = function( obj,x,y,dx,dy,count,fling ) { prompt( "#", "App.SimulateScroll(\f"+obj.id+"\f"+x+"\f"+y+"\f"+dx+"\f"+dy+"\f"+count+"\f"+fling ); }
	/*#app*/ this._273 = function( obj,keyName,modifiers,pause ) { prompt( "#", "App.SimulateKey(\f"+obj.id+"\f"+keyName+"\f"+modifiers+"\f"+pause ); }
	/*#app*/ this._274 = function( id,key ) { return parseFloat(prompt( "#", "App.GetJoyState(\f"+id+"\f"+key)); }
	/*#app*/ this._275 = function( id ) { return eval(prompt( "#", "App.GetJoyStates(\f"+id)); }
	/*#app*/ this._276 = function( id ) { return prompt( "#", "App.GetJoyName(\f"+id); }
	/*#app*/ this._277 = function( options ) { prompt( "#", "App.SetJoystickOptions(\f"+options ); }
	/*#app*/ this._278 = function( auto ) { prompt( "#", "App.SetAutoBoot(\f"+auto); }
	this._279 = function( auto ) { prompt( "#", "App.SetAutoWifi(\f"+auto); }
	this._280 = function( appName ) { prompt( "#", "App.SetAutoStart(\f"+appName); }
	/*#app*/ this._281 = function( type,baseUrl,path,params,callback,headers ) { prompt( "#", "App.HttpRequest(\f"+type+"\f"+baseUrl+"\f"+path+"\f"+params+"\f"+_Cbm(callback)+"\f"+headers); }
	/*#app*/ this._282 = function( url,file,name,callback ) { prompt( "#", "App.UploadFile(\f"+url+"\f"+file+"\f"+name+"\f"+_Cbm(callback) ); }
	/*#app*/ this._283 = function() { prompt( "#", "App.SaveCookies(" ); }
	/*#app*/ this._284 = function() { prompt( "#", "App.ClearCookies(" ); }
	/*#app*/ this._285 = function( agent,options ) { prompt( "#", "App.SetUserAgent(\f"+agent+"\f"+options ); }
    /*#app*/ this._286 = function( name,password ) { prompt( "#", "App.SetUserCreds(\f"+name+"\f"+password ); }
    /*#app*/ this._287 = function( uri,columns,select,args,sort ) { return eval(prompt( "#", "App.QueryContent(\f"+uri+"\f"+columns+"\f"+select+"\f"+args+"\f"+sort)); }
	/*#app*/ this._288 = function( uri,options ) { return prompt( "#", "App.Uri2Path(\f"+uri+"\f"+options); }
	/*#app*/ this._289 = function( path ) { return prompt( "#", "App.Path2Uri(\f"+path); }
	/*#app*/ this._290 = function( path ) { return prompt( "#", "App.RealPath(\f"+path); }
	/*#app*/ this._291 = function( fileName,quality ) { prompt( "#", "App.ScreenShot(\f"+fileName+"\f"+quality ); }
	/*#app*/ this._292 = function() { prompt( "#", "App.Print(" ); }
	/*#app*/ this._293 = function( packageName,className ) { prompt( "#", "App.InstallWallpaper\f"+packageName+"\f"+className ); }
	...
	/*#app*/ this._295 = function( apkFile,callback,options ) { prompt( "#", "App.InstallApp(\f"+apkFile+"\f"+_Cbm(callback)+"\f"+options ); }
	/*#app*/ this._296 = function() { return JSON.parse(prompt( "#", "App.GetAccessibility(" )); }
	/*#app*/ this._297 = function() { return JSON.parse(prompt( "#", "App.GetSpeechEngines(" )); }

	//These objects auto-release when layout is destroyed.
	/*#app*/ this._298 = function( type,options ) { var ret = prompt( "#", "App.CreateLayout("+type+"\f"+options ); if( ret ) return new Lay(ret); else return null; }
	/*#app*/ this._299 = function( file,width,height,options,w,h ) { var ret = prompt( "#", "App.CreateImage("+file+"\f"+width+"\f"+height+"\f"+options+"\f"+w+"\f"+h );  if( ret ) return new Img(ret); else return null; }
	/*#app*/ this._300 = function( width,height,options,w,h ) { var ret = prompt( "#", "App.CreateCanvas(\f"+width+"\f"+height+"\f"+options+"\f"+w+"\f"+h );  if( ret ) return new Img(ret); else return null; }
	/*#app*/ this._301 = function( lay,file,width,height,options,w,h ) { var ret = prompt( (lay?lay.id:null), "App.AddImage("+file+"\f"+width+"\f"+height+"\f"+options+"\f"+w+"\f"+h );  if( ret ) return new Img(ret); else return null; }
	/*#app*/ this._302 = function( lay,width,height,options,w,h ) { var ret = prompt( (lay?lay.id:null), "App.AddCanvas(\f"+width+"\f"+height+"\f"+options+"\f"+w+"\f"+h );  if( ret ) return new Img(ret); else return null; }
	/*#app*/ this._303 = function( text,width,height,options ) { var ret = prompt( "#", "App.CreateButton("+text+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Btn(ret); else return null;  }
	/*#app*/ this._304 = function( lay,text,width,height,options ) { var ret = prompt( (lay?lay.id:null), "App.AddButton("+text+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Btn(ret); else return null;  }
	/*#app*/ this._305 = function( text,width,height,options ) { var ret = prompt( "#", "App.CreateToggle("+text+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Tgl(ret); else return null;  }
	/*#app*/ this._306 = function( lay,text,width,height,options ) { var ret = prompt( (lay?lay.id:null), "App.AddToggle("+text+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Tgl(ret); else return null;  }
	/*#app*/ this._307 = function( text,width,height,options ) { var ret = prompt( "#", "App.CreateSwitch("+text+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Swi(ret); else return null;  }
	/*#app*/ this._308 = function( lay,text,width,height,options ) { var ret = prompt( (lay?lay.id:null), "App.AddSwitch("+text+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Swi(ret); else return null;  }
	/*#app*/ this._309 = function( text,width,height,options ) { var ret = prompt( "#", "App.CreateCheckBox("+text+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Chk(ret); else return null;  }
	/*#app*/ this._310 = function( lay,text,width,height,options ) { var ret = prompt( (lay?lay.id:null), "App.AddCheckBox("+text+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Chk(ret); else return null;  }
	/*#app*/ this._311 = function( list,width,height,options ) { var ret = prompt( "#", "App.CreateSpinner("+list+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Spn(ret); else return null; }
	/*#app*/ this._312 = function( lay,list,width,height,options ) { var ret = prompt( (lay?lay.id:null), "App.AddSpinner("+list+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Spn(ret); else return null; }
	/*#app*/ this._313 = function( width,height,options ) { var ret = prompt( "#", "App.CreateSeekBar("+width+"\f"+height+"\f"+options ); if( ret ) return new Skb(ret); else return null; }
	/*#app*/ this._314 = function( lay,width,height,options ) { var ret = prompt( (lay?lay.id:null), "App.AddSeekBar("+width+"\f"+height+"\f"+options ); if( ret ) return new Skb(ret); else return null; }
	/*#app*/ this._315 = function( text,width,height,options ) { var ret = prompt( "#", "App.CreateText("+text+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Txt(ret); else return null; }
	/*#app*/ this._316 = function( lay,text,width,height,options ) { var ret = prompt( (lay?lay.id:null), "App.AddText("+text+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Txt(ret); else return null; }
	/*#app*/ this._317 = function( text,width,height,options ) { var ret = prompt( "#", "App.CreateTextEdit("+text+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Txe(ret); else return null; }
	/*#app*/ this._318 = function( lay,text,width,height,options ) { var ret = prompt( (lay?lay.id:null), "App.AddTextEdit("+text+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Txe(ret); else return null; }
	/*#app*/ this._319 = function( list,width,height,options,delim ) { var ret = prompt( "#", "App.CreateList(\f"+list+"\f"+width+"\f"+height+"\f"+options+"\f"+delim ); if( ret ) return new Lst(ret); else return null; }
	/*#app*/ this._320 = function( lay,list,width,height,options,delim ) { var ret = prompt( (lay?lay.id:null), "App.AddList(\f"+list+"\f"+width+"\f"+height+"\f"+options+"\f"+delim ); if( ret ) return new Lst(ret); else return null; }
	/*#app*/ this._321 = function( width,height,options,zoom ) { var ret = prompt( "#", "App.CreateWeb(\f"+width+"\f"+height+"\f"+options+"\f"+zoom ); if( ret ) return new Web(ret); else return null; }
	/*#app*/ this._322 = function( lay,width,height,options,zoom ) { var ret = prompt( (lay?lay.id:null), "App.AddWeb(\f"+width+"\f"+height+"\f"+options+"\f"+zoom ); if( ret ) return new Web(ret); else return null; }
	/*#app*/ this._323 = function( width,height,options ) { var ret = prompt( "#", "App.CreateScroller("+width+"\f"+height+"\f"+options ); if( ret ) return new Scr(ret); else return null; }
	/*#app*/ this._324 = function( lay,width,height,options ) { var ret = prompt( (lay?lay.id:null), "App.AddScroller("+width+"\f"+height+"\f"+options ); if( ret ) return new Scr(ret); else return null; }
	/*#app*/ this._325 = function( width,height,options ) { var ret = prompt( "#", "App.CreateCameraView("+width+"\f"+height+"\f"+options );  if( ret ) return new Cam(ret); else return null; }
	/*#app*/ this._326 = function( lay,width,height,options ) { var ret = prompt( (lay?lay.id:null), "App.AddCameraView("+width+"\f"+height+"\f"+options );  if( ret ) return new Cam(ret); else return null; }
	/*#app*/ this._327 = function( width,height,options ) { var ret = prompt( "#", "App.CreateVideoView(\f"+width+"\f"+height+"\f"+options );  if( ret ) return new Vid(ret); else return null; }
	/*#app*/ this._328 = function( lay,width,height,options ) { var ret = prompt( (lay?lay.id:null), "App.AddVideoView(\f"+width+"\f"+height+"\f"+options );  if( ret ) return new Vid(ret); else return null; }
	/*#app*/ this._329 = function( text,width,height,options ) { var ret = prompt( "#", "App.CreateCodeEdit(\f"+text+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Cde(ret); else return null; }
	/*#app*/ this._330 = function( lay,text,width,height,options ) { var ret = prompt( (lay?lay.id:null), "App.AddCodeEdit(\f"+text+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Cde(ret); else return null; }
	/*#app*/ this._331 = function( unitId,testId,width,height,options ) { var ret = prompt( "#", "App.CreateAdView(\f"+unitId+"\f"+testId+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Adv(ret); else return null; }
	/*#app*/ this._332 = function( lay,unitId,testId,width,height,options ) { var ret = prompt( (lay?lay.id:null), "App.AddAdView(\f"+unitId+"\f"+testId+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Adv(ret); else return null; }


	//These objects auto-release (ie. single instance)
	/*#app*/ this._333 = function( msg,options ) { if( _ynd ) _ynd.Release(); var ret = prompt( "#", "App.CreateYesNoDialog(\f"+msg+"\f"+options ); if( ret ) _ynd = new Ynd(ret); else _ynd = null; return _ynd; }
	/*#app*/ this._334 = function( title,list,options ) { if( _ldg ) _ldg.Release(); var ret = prompt( "#", "App.CreateListDialog(\f"+title+"\f"+list+"\f"+options ); if( ret ) _ldg = new Ldg(ret); else _ldg = null; return _ldg; }
	...
	/*#app*/ this._335 = function( filter ) { if( _btl ) _btl.Release(); var ret = prompt( "#", "App.CreateBluetoothList("+filter ); if( ret) _btl = new Btl(ret); else _btl = null; return _btl; }
	/*#app*/ this._336 = function() { if( _rec ) _rec.Release(); var ret = prompt( "#", "App.CreateAudioRecorder(" ); if( ret) _rec = new Rec(ret); else _rec = null; return _rec; }
	/*#app*/ this._337 = function() { if( _sms ) _sms.Release(); var ret = prompt( "#", "App.CreateSMS(" ); if( ret) _sms = new SMS(ret); else _sms = null; return _sms; }
	/*#app*/ this._338 = function( account,password ) { if( _eml ) _eml.Release(); var ret = prompt( "#", "App.CreateEmail("+account+"\f"+password ); if( ret) _eml = new EMAIL(ret); else _eml = null; return _eml; }
	/*#app*/ this._339 = function( type ) { if( _smw ) _smw.Release(); var ret = prompt( "#", "App.CreateSmartWatch(\f"+type ); if( ret) _smw = new SMW(ret); else _smw = null; return _smw; }
	/*#app*/ this._340 = function( options ) { if( _crp ) _crp.Release(); var ret = prompt( "#", "App.CreateCrypt(\f"+options ); if( ret) _crp = new Crp(ret); else _crp = null; return _crp; }
	/*#app*/ this._341 = function( options ) { if( _spr ) _spr.Release(); var ret = prompt( "#", "App.CreateSpeechRec(\f"+options ); if( ret) _spr = new Spr(ret); else _spr = null; return _spr; }
	/*#app*/ this._342 = function( types ) { if( _pst ) _pst.Release(); var ret = prompt( "#", "App.CreatePhoneState(\f"+types ); if( ret) _pst = new Pst(ret); else _pst = null; return _pst; }
	/*#app*/ this._343 = function( options ) { if( _wpr ) _wpr.Release(); var ret = prompt( "#", "App.CreateWallpaper(\f"+options ); if( ret) _wpr = new Wpr(ret); else _wpr = null; return _wpr; }

	//These objects need releasing manually.
	/*#app*/ this._344 = function( baseTheme ) { var ret = prompt( "#", "App.CreateTheme(\f"+baseTheme ); if( ret ) return new Thm(ret); else return null;  }
	/*#app*/ this._345 = function( title,options ) { var ret = prompt( "#", "App.CreateDialog(\f"+title+"\f"+options ); if( ret ) return new Dlg(ret); else return null; }
	/*#app*/ this._346 = function( options ) { var ret = prompt( "#", "App.CreateOverlay(\f"+options ); if( ret ) return new Ovl(ret); else return null; }
	/*#app*/ this._347 = function() { var ret = prompt( "#", "App.CreateMediaPlayer(" ); if( ret ) return new Aud(ret); else return null; }
	/*#app*/ this._348 = function( type,options ) { var ret = prompt( "#", "App.CreateSensor("+type+"\f"+options ); if( ret ) return new Sns(ret); else return null; }
	/*#app*/ this._349 = function( type,options ) { var ret = prompt( "#", "App.CreateLocator("+type+"\f"+options ); if( ret ) return new Loc(ret); else return null; }
	/*#app*/ this._350 = function( type ) { var ret = prompt( "#", "App.CreateNetClient("+type ); if( ret ) return new Net(ret); else return null; }
	/*#app*/ this._351 = function() { var ret = prompt( "#", "App.CreateNxtRemote(" ); if( ret ) return new Nxt(ret,null); else return null; }
	/*#app*/ this._352 = function( port,options ) { var ret = prompt( "#", "App.CreateWebServer("+port+"\f"+options ); if( ret ) return new Wbs(ret); else return null; }
	/*#app*/ this._353 = function( baudRate,dataBits,stopBits,parity,device ) { var ret = prompt( "#", "App.CreateUSBSerial(\f"+baudRate+"\f"+dataBits+"\f"+stopBits+"\f"+parity+"\f"+device ); if( ret ) return new Usb(ret); else return null; }
	/*#app*/ this._354 = function( cmd,env,dir,options ) { var ret = prompt( "#", "App.CreateSysProc(\f"+cmd+"\f"+env+"\f"+dir+"\f"+options ); if( ret ) return new Sys(ret); else return null; }
	/*#app*/ this._355 = function( packageName,className,callback,options ) { var ret = prompt( "#", "App.CreateService(\f"+packageName+"\f"+className+"\f"+options+"\f"+_Cbm(callback) ); if( ret ) return new Svc(ret); else return null; }
	/*#app*/ this._356 = function( type ) { var ret = prompt( "#", "App.CreateSynth("+type ); if( ret ) return new Syn(ret); else return null; }
	/*#app*/ this._357 = function( mode ) { var ret = prompt( "#", "App.CreateBluetoothSerial(\f"+mode ); if( ret ) return new Bts(ret); else return null; }
	/*#app*/ this._358 = function( mode ) { var ret = prompt( "#", "App.CreateZipUtil(\f"+mode ); if( ret ) return new Zip(ret); else return null; }
	/*#app*/ this._359 = function( options ) { var ret = prompt( "#", "App.CreateDownloader(\f"+options ); if( ret ) return new Dwn(ret); else return null; }
	/*#app*/ this._360 = function() { var ret = prompt( "#", "App.CreateMediaStore(" ); if( ret ) return new Med(ret); else return null; }
	/*#app*/ this._361 = function() { var ret = prompt( "#", "App.CreatePlayStore(" ); if( ret ) return new Ply(ret); else return null; }
	/*#app*/ this._362 = function( options ) { var ret = prompt( "#", "App.CreateNotification(\f"+options ); if( ret ) return new Not(ret); else return null; }
	/*#app*/ this._363 = function( file,mode ) { var ret = prompt( "#", "App.CreateFile(\f"+file+"\f"+mode ); if( ret ) return new Fil(ret); else return null; }

	//----- Special methods ---------------------

	this._364 = function() {
	    if(typeof OnStart=='function') {
	        _dbg = app._119(); OnStart(); prompt("#","_Start"); _started=true;
	    }
	    if(typeof onStart=='function') {
            _dbg = app._119(); onStart(); prompt("#","_Start"); _started=true;
        }
	...
	/*#app*/ this._371 = function() { return _languages.langs; }
	...
	//For Python.
	/*#app*/ this._374 = function( callback, delay, args ) { setTimeout.apply(null,arguments) }
    /*#app*/ this._375 = function( callback, delay, args ) { setInterval.apply(null,arguments) }

	//Helper classes.
	/*#app*/ this._376 = function() { var nxtHelp = new _NxtHelp(); return nxtHelp.nxt_CreateNxt(); }
	/*#app*/ this._377 = function( list,width,height,options ) { return new _Tabs( list,width,height,options ); }
	/*#app*/ this._378 = function( address,id,retry,options ) { return new _WebSock( address,id,retry,options ); }
	/*#app*/ this._379 = function( title,width,height,callback,options ) { return new _Wizard( title,width,height,callback,options ) }
	/*#app*/ this._380 = function( file,orient ) { return new _Game( file,orient ) }

	//Externally defined methods.
	/*#app*/ this._381 = function( title,deflt,callback ) { _ShowTextDialog( title,deflt,callback ) }
	/*#app*/ this._382 = function( title,list,callback,width,height,options ) { return new _CheckList( title,list,callback,width,height,options ); }
	/*#app*/ this._383 = function( msg,left,top,timeOut,options ) { _ShowTip( msg,left,top,timeOut,options ) }
	/*#app*/ this._384 = function( file ) { _PlaySound( file ) }
	/*#app*/ this._385 = function( title1,title2,callback,options,extra ) { var wifi = new _WifiScan( title1,title2,callback,options,extra ); wifi.Select(); }

	//Internal plugins.
	/*#app*/ this._386 = function() { _LoadScriptSync( "/Sys/plugs/Music/Music.inc" ); return new Music() }
	/*#app*/ this._387 = function( key,server ) { _LoadScriptSync( "/Sys/cloud.js" ); return new CloudStore(key,server) }
	/*#app*/ this._388 = function() { _LoadPlugin("CustomTabs"); return new CustomTabsWrapperClass() }
	/*#app*/ this._389 = function(paths,options) { _LoadPlugin("Node"); return new Node(paths,options) }
...
TW = function(txt,size) { return app._294(txt,size,0,null).width; }
DW = function(){ return app._157() }
DH = function(){ return app._158() }
...
_SetTempDebug = function(sw) { if(_dbg != _dbgSave) app._118(sw, _dbgSave = _dbg); }
_RestoreDebug = function() { if(_dbg != _dbgSave) app._118(_dbgSave = _dbg); }
...
_LoadScriptSync = function( url, defer, type, id )
{
    ...
    if( _isV8 ) _ExecV8(url);
        ...
        if( defer ) { script.defer = true; script.src = app._290(url) }
        else {
            var dbg = _dbg; _UseDbg( false );
...
OnCreate = function(extract,debug,game)
{
    _dbg = app._119();
	if( debug ) app._123();
	if( game ) { app._380(); prompt("#","_Start"); _started=true; }
...
_Log = function( msg ) { app._115( msg ); }
_Err = function( msg ) { app._115( "ERROR: " + msg ); }
